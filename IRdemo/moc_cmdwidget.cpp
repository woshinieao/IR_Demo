...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CmdWidget_t, stringdata0) + ofs \
...
void *CmdWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CmdWidget.stringdata0))
        return static_cast<void*>(const_cast< CmdWidget*>(this));
    if (!strcmp(_clname, "Ui_CmdWidget"))
        return static_cast< Ui_CmdWidget*>(const_cast< CmdWidget*>(this));
